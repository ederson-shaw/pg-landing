...
(() => {
  ...
  const board = (kind) => {
    switch (kind) {
      ...
      case 'rail':
        return `<div class="l-board l-board--rail"><div class="l-board-head"><span>BUYER CONTEXT / NORTHSTAR</span><i>HANDOFF VIEW</i></div><div class="l-handoff-grid"><article><small>FROM THE BRIEF</small><b>Implementation concern</b><span>Known evidence carried into the call</span></article><em aria-hidden="true">→</em><article class="is-live"><small>LIVE MOMENT</small><b>Risk returned</b><span>HumanCue keeps the change visible</span></article><em aria-hidden="true">→</em><article><small>NEXT OWNER</small><b>Seller validates authority</b><span>Manager sees the evidence after the call</span></article></div><div class="l-board-foot"><span>context moves forward with evidence</span><span class="l-live-dot">↗</span></div></div>`;
      case 'brief':
        return `<div class="l-board l-board--brief"><div class="l-board-head"><span>PRE-CALL BRIEF / RUSSELL P.</span><i>DISCOVERY</i></div><div class="l-brief-grid"><article><small>SOURCE</small><b>Previous rollout concern</b><span>Prior call · direct evidence</span></article><article><small>POINT OF VIEW</small><b>Needs internal proof</b><span>Hypothesis to challenge</span></article><article><small>QUESTION TO TEST</small><b>Who owns approval?</b><span>Ask before advancing</span></article></div><div class="l-board-foot"><span>evidence grouped by confidence</span><span class="l-chip">OPEN BRIEF</span></div></div>`;
      case 'blueprint':
        return `<div class="l-board l-board--blueprint"><div class="l-board-head"><span>BUYER'S BLUEPRINT / NORTHSTAR</span><i>WORKING HYPOTHESIS</i></div><div class="l-blueprint-grid"><div><small>BUYER ROLE</small><b>Operational sponsor</b></div><div><small>DECISION CRITERIA</small><b>Proof the rollout will hold</b></div><div><small>QUESTION PATH</small><b>Who must believe this?</b></div><div class="l-blueprint-accent"><small>NEXT VALIDATION</small><b>Test internal bandwidth</b></div></div><div class="l-board-foot"><span>prepare → observe → validate</span><span class="l-chip l-chip--amber">NOT FINAL</span></div></div>`;
      case 'moment':
      ...
      case 'readiness':
        return `<div class="l-board l-board--readiness"><div class="l-board-head"><span>READINESS HANDOFF / NORTHSTAR</span><i>DECISION CONTEXT</i></div><div class="l-readiness-plan"><article><small>WHAT MOVED</small><b>Buyer opened a decision process</b><span>Evidence changed after the call.</span></article><article><small>WHAT IS STILL MISSING</small><b>Economic owner is not involved</b><span>Readiness is not complete.</span></article><article class="is-next"><small>NEXT ACTION</small><b>Invite the decision owner</b><span>Validate before advancing the stage.</span></article></div><div class="l-board-foot"><span>trust · confidence · urgency · safety · risk · willingness</span><span class="l-chip l-chip--cyan">SHIFT</span></div></div>`;
      case 'alignment':
